            ...
            {filtered.map((f) => (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="text-sm font-semibold text-slate-900 dark:text-slate-100">{f.nama}</h4>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="text-sm font-semibold text-slate-900 dark:text-slate-100">{p.nama}</h4>
                      <div className="flex items-center gap-2 mt-0.5 text-xs text-muted-foreground">
                        <span>Fakultas: <strong className="text-slate-700 dark:text-slate-300 font-medium">{parentFak?.nama || "(Tanpa Fakultas)"}</strong></span>
                      </div>
                    </div>
                  </div>
                  <div className="flex items-center gap-1">
                    <Button
                      ...
                      variant="ghost"
                      className="h-8 w-8 text-slate-500 hover:text-primary"
                      onClick={() => setForm({ id: p.id, nama: p.nama, fakultasId: p.parentId || "none" })}
                      title="Edit"
                    >
                      <Edit2 className="h-3.5 w-3.5" />
                    </Button>
        ...
        <CardContent className="p-5 space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            >
              ...
              <SelectContent>
                <SelectItem value="none" disabled>Pilih Fakultas</SelectItem>
                {fakultas.map((f) => (
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="text-sm font-semibold text-slate-900 dark:text-slate-100">{k.nama}</h4>
                      <div className="flex items-center gap-2 mt-0.5 text-xs text-muted-foreground">
                        <span>Prodi: <strong className="text-slate-700 dark:text-slate-300 font-medium">{parentProdi?.nama || "(Tanpa Prodi)"}</strong></span>
                      </div>
                    </div>
                  </div>
                  <div className="flex items-center gap-1">
                    <Button
                      ...
                      variant="ghost"
                      className="h-8 w-8 text-slate-500 hover:text-primary"
                      onClick={() => setForm({ id: k.id, nama: k.nama, prodiId: k.parentId || "none" })}
                      title="Edit"
                    >
                      <Edit2 className="h-3.5 w-3.5" />
                    </Button>
        ...
        <CardContent className="p-5 space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            >
              ...
              <SelectContent>
                <SelectItem value="none" disabled>Pilih Program Studi</SelectItem>
                {prodi.map((p) => (
