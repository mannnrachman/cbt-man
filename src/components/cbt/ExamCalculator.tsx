...
export function ExamCalculator() {
  ...
  const numBtn = cn(btnBase, "h-9 bg-slate-100 text-slate-800 border-slate-300 hover:bg-slate-200 text-sm");
  const opBtn = cn(btnBase, "h-9 bg-indigo-500 text-white border-indigo-700 hover:bg-indigo-600 text-base");
  const funcBtn = cn(btnBase, "h-9 bg-slate-700 text-slate-200 border-slate-900 hover:bg-slate-600 text-xs");
  const acBtn = cn(btnBase, "h-9 bg-rose-500 text-white border-rose-700 hover:bg-rose-600 text-xs");
  const eqBtn = cn(btnBase, "h-9 bg-emerald-500 text-white border-emerald-700 hover:bg-emerald-600 text-lg");
  ...
  return (
    <div className="mx-auto flex w-[380px] min-w-[380px] flex-col gap-3 rounded-2xl bg-slate-800 p-4 shadow-[inset_0_1px_1px_rgba(255,255,255,0.2),_0_10px_15px_-3px_rgba(0,0,0,0.3)] border border-slate-700">
